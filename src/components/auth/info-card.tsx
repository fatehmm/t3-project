...
//TODO: Change the name from infocard to email change card ??maybe??
  ...
  return (
    ...
    >
      <div className="flex w-full justify-center">
        <div className="relative right-1 grid place-items-center rounded-full border border-dashed border-green-700 p-6 text-green-700">
          <Icon className="size-10 text-green-700" aria-hidden="true" />
        </div>
      </div>
